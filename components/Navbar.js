  ...
  return (
    <div className="p-3 bg-blue-800 flex justify-between shadow-lg">
      <div className="flex w-full items-center">
        <Image src="/rccg.png" width={50} height={50} alt="RCCG LOGO" />
      ...
      <div>
        <form className="flex w-full sm:w-60 my-3 sm:my-0">
          <input
            ...
            required
          />
          <button className="px-3 rounded-r-lg bg-gray-700  text-gray-800 font-bold py-2 uppercase border-blue-800 border-t border-b border-r focus:outline-none">
